      ...
      <main>
        ...
        <section className="relative h-[100svh] min-h-[600px] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 text-center px-[clamp(1.5rem,4vw,4rem)] w-full max-w-4xl mx-auto mt-4 md:-mt-6 lg:-mt-4 2xl:mt-4">
            ...
            >
              <Link href="/behandlinger" className="inline-block bg-[#D3B39E] text-white px-[clamp(2.25rem,3.5vw,3rem)] py-[clamp(0.8125rem,1.3vw,1.0625rem)] text-[0.9375rem] md:px-[1.75rem] md:py-[0.6rem] md:text-[0.8125rem] lg:px-[clamp(2.25rem,2.8vw,2.75rem)] lg:py-[clamp(0.8rem,1vw,0.9rem)] lg:text-[0.9375rem] 2xl:px-[clamp(3rem,4vw,4rem)] 2xl:py-[clamp(1.125rem,1.5vw,1.25rem)] 2xl:text-[1.0625rem] font-body font-bold tracking-wide rounded-full shadow-[0_10px_30px_rgba(211,179,158,0.3)] hover:shadow-[0_15px_40px_rgba(211,179,158,0.5)] hover:-translate-y-1 hover:bg-[#C9A189] transition duration-1000 ease-out">
                Udforsk ydelser
              </Link>
            </motion.div>
          </div>
