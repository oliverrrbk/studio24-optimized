            ...
            <div className="grid md:grid-cols-[1.3fr_1fr] lg:grid-cols-[1fr_1fr] 2xl:grid-cols-[1.3fr_1fr] gap-[clamp(4rem,8vw,10rem)] lg:gap-12 2xl:gap-[clamp(4rem,8vw,10rem)] mt-[1rem] md:mt-[clamp(2.5rem,4vw,4rem)] w-full items-start px-4 md:px-0 lg:translate-x-0 transition-transform">
              ...
              >
                ...
                <div className="relative w-full md:w-[80%] lg:w-[68%] 2xl:w-[90%] ml-auto aspect-[1/1] rounded-[50%] overflow-hidden group">
                  <Image src="/new_gallery/50.png" alt="Frisør behandling" fill className="object-cover transition-transform duration-[2s] group-hover:scale-105 contrast-[0.85] saturate-[0.85] brightness-[1.05]" />
                </div>
