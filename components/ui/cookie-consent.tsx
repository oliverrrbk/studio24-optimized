        ...
        <AnimatePresence>
          {visible && (
            <motion.div
              ...
              className="pointer-events-auto w-full max-w-[380px] md:max-w-[342px] 2xl:max-w-[380px] bg-[#FDFBF7] border border-[#4C433C]/10 rounded-[25.5px] shadow-[0_25px_70px_-15px_rgba(44,38,33,0.28)] p-[clamp(1.75rem,3vw,2.5rem)] md:p-5 2xl:p-[clamp(1.75rem,3vw,2.5rem)] flex flex-col gap-[clamp(1.5rem,2.5vw,2rem)]"
            >
              <div>
