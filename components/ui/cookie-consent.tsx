...
export function CookieConsent() {
  ...
  return (
    <>
      <div className="fixed inset-0 z-[90] pointer-events-none flex items-end justify-start p-[clamp(1rem,3vw,2rem)] md:pl-5 md:pb-5 min-[1440px]:pl-[clamp(1rem,3vw,2rem)] min-[1440px]:pb-[clamp(1rem,3vw,2rem)]">
        <AnimatePresence>
          {visible && (
            <motion.div
              role="region"
              ...
              className="pointer-events-auto w-full max-w-[380px] md:max-w-[339px] min-[1440px]:max-w-[380px] bg-[#FDFBF7] border border-[#4C433C]/10 rounded-[25.5px] shadow-[0_25px_70px_-15px_rgba(44,38,33,0.28)] p-[clamp(1.75rem,3vw,2.5rem)] md:p-5 min-[1440px]:p-[clamp(1.75rem,3vw,2.5rem)] flex flex-col gap-[clamp(1.5rem,2.5vw,2rem)]"
            >
              <div>
