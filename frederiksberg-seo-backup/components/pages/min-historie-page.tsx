...
function ScrollManifestoItem({ item, idx, isMobile }: any) {
  ...
  const mobileIconColor = useTransform(scrollYProgress, [0.1, 0.3, 0.5, 0.7], ["#887A70", "#D3B39E", "#D3B39E", "#887A70"]);
        ...
        >
          ...
          >
            <h4 
              ...
              style={{ 
                backgroundImage: "linear-gradient(to right, #1c1a18 0%, #D3B39E 25%, #1c1a18 50%, #D3B39E 75%, #1c1a18 100%)",
...
export default function MinHistoriePage() {
  ...
  return (
    <div className="bg-[#FDFBF7] text-[#1c1a18] font-sans antialiased min-h-[100svh] flex flex-col selection:bg-[#D3B39E] selection:text-white">
      ...
      <main className="flex-1 pt-[clamp(7rem,10vw,10rem)] 2xl:pt-[clamp(10rem,12vw,12rem)] pb-0 overflow-x-hidden">
        ...
        >
          ...
          <div className="absolute top-[-15%] right-[-10%] w-[clamp(270px,45vw,500px)] 2xl:w-[clamp(500px,50vw,600px)] aspect-square z-0 pointer-events-none opacity-40">
             <div className="absolute inset-0 rounded-full" style={{background: 'radial-gradient(circle, rgba(228,211,196,0.45) 0%, transparent 70%)'}}></div>
             <div className="absolute inset-[-10%] rounded-full" style={{background: 'radial-gradient(circle, rgba(211,179,158,0.25) 0%, transparent 70%)'}}></div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-[clamp(3.5rem,6vw,6rem)] 2xl:gap-[clamp(6rem,8vw,8rem)] items-center relative z-10">
            <div className="flex flex-col relative z-10">
              ...
              <motion.p style={hardwareAccelerated} variants={fadeInUp} className="text-[clamp(1rem,1.2vw,1.2rem)] 2xl:text-[clamp(1.2rem,1.4vw,1.35rem)] font-sans text-[#6A5D55] font-light leading-relaxed max-w-[450px] 2xl:max-w-[500px]">
                Med min 4,5-årige frisøruddannelse og over 10 års erfaring skabte jeg Studio 24 her på Frederiksberg. Jeg nægtede at arbejde i en branche, hvor uret bestemmer. For mig tager ærligt håndværk og et smukt resultat den tid, det tager. Længere er den egentlig ikke.
              </motion.p>
            </div>
            <div className="relative w-[85%] ml-[11%] mr-auto md:w-[90%] md:ml-auto md:mr-0 mt-8 md:mt-0">
              ...
              <motion.div 
                ...
                className="absolute -bottom-6 -left-8 md:-bottom-8 md:-left-8 bg-[#FDFBF7] p-[clamp(1.2rem,2.5vw,2rem)] 2xl:p-[clamp(2rem,3vw,2.5rem)] max-w-[240px] md:max-w-[280px] 2xl:max-w-[320px] shadow-[-30px_40px_100px_rgba(211,179,158,0.15)] z-10 rounded-[2px]"
              >
        ...
        >
          ...
          <div className="relative z-10 max-w-[800px] mx-auto">
            ...
            <motion.div style={hardwareAccelerated} variants={fadeInUp}>
              <Link 
                className="inline-block bg-[#D3B39E] text-white px-[clamp(1.8rem,3vw,2.7rem)] 2xl:px-[clamp(2rem,3.5vw,3rem)] py-[clamp(0.9rem,1.3vw,1.1rem)] 2xl:py-[clamp(1rem,1.5vw,1.25rem)] rounded-full font-label tracking-[0.2em] uppercase text-[clamp(0.6rem,0.9vw,0.7rem)] 2xl:text-[clamp(0.7rem,1vw,0.8rem)] font-bold shadow-[0_15px_40px_rgba(211,179,158,0.4)] hover:shadow-[0_20px_50px_rgba(211,179,158,0.6)] hover:-translate-y-1 hover:bg-[#C9A189] transition duration-1000 ease-out"
                href="?booking=true"
                scroll={false}
              >
                Find din tid her
