    ...
    <>
      ...
      <main>
        ...
        <section className="relative h-[100svh] min-h-[600px] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 text-center px-[clamp(1.5rem,4vw,4rem)] w-full max-w-4xl mx-auto mt-4 lg:-mt-12 2xl:mt-4">
            ...
            <motion.p style={hardwareAccelerated} 
              ...
              className="font-body text-[#6A5D55] text-[clamp(0.95rem,1.15vw,1.0625rem)] lg:text-[clamp(1rem,1.3vw,1.15rem)] 2xl:text-[clamp(1.15rem,1.5vw,1.35rem)] max-w-2xl lg:max-w-3xl 2xl:max-w-4xl mx-auto mb-[clamp(1.5rem,3vw,2.5rem)] 2xl:mb-[clamp(2rem,3.5vw,3rem)] font-light leading-relaxed drop-shadow-sm"
            >
