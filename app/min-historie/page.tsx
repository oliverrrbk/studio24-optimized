    ...
    >
      <div ref={ref} className="w-full flex flex-col items-center">
        <motion.div 
          ...
          className={`bg-[#FAF8F5] p-5 rounded-full mb-[clamp(1.5rem,2vw,2rem)] text-[#887A70] shadow-[0_4px_20px_rgba(28,26,24,0.03)] transition-[transform,background-color,color,box-shadow] duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] ${!isMobile ? 'group-hover:bg-[#F3EFE9] group-hover:-translate-y-2 group-hover:scale-[1.02] group-hover:text-[#EDB7A9] group-hover:shadow-[0_15px_30px_rgba(28,26,24,0.06)]' : ''}`}
        >
        ...
        <motion.div 
          ...
          className={`relative w-full flex flex-col items-center transition-transform duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] ${!isMobile ? 'group-hover:-translate-y-2 group-hover:scale-[1.04]' : ''}`}
        >
          <motion.div 
