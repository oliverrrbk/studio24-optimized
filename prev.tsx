...
export default function MinHistoriePage() {
  ...
  return (
    <div className="bg-[#FDFBF7] text-[#1c1a18] font-sans antialiased min-h-screen flex flex-col selection:bg-[#EDB7A9] selection:text-white">
      ...
      <main className="flex-1 pt-[clamp(8rem,12vw,12rem)] pb-0 overflow-x-hidden">
        {/* Hero Section: Editorial Intro */}
        <motion.section 
          initial="hidden"
          animate="visible"
          variants={staggerContainer}
          className="max-w-[1400px] mx-auto px-[clamp(1.5rem,5vw,4rem)] mb-[clamp(6rem,10vw,10rem)] relative"
        >
          {/* Subtle pulsating gradient blob in top right corner */}
          <div className="absolute top-[-15%] right-[-10%] w-[clamp(300px,50vw,600px)] aspect-square z-0 pointer-events-none opacity-40">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-[clamp(4rem,8vw,8rem)] items-center relative z-10">
            <div className="flex flex-col relative z-10">
              <motion.span variants={fadeInUp} className="font-label text-[clamp(0.6rem,0.8vw,0.75rem)] uppercase tracking-[0.3em] text-[#92857C] mb-[clamp(1.5rem,3vw,2.5rem)] block">
                Visionen bag Atelieret
              </motion.span>
              <motion.h1 variants={fadeInUp} className="text-[clamp(3rem,5vw,5.5rem)] font-headline text-[#1c1a18] font-light leading-[1.05] tracking-tight mb-[clamp(2rem,4vw,3rem)]">
                Et oprør mod <br /> <span className="italic">samlebåndet.</span>
              </motion.h1>
              <motion.p variants={fadeInUp} className="text-[clamp(1.1rem,1.4vw,1.35rem)] font-sans text-[#6A5D55] font-light leading-relaxed max-w-[500px]">
            ...
            <div className="relative">
              ...
              <motion.div 
                ...
                className="absolute -bottom-8 -left-8 bg-[#FDFBF7]/80 backdrop-blur-md p-[clamp(1.5rem,3vw,2.5rem)] max-w-[320px] shadow-[-30px_40px_100px_rgba(237,183,169,0.15)] z-10 hidden md:block rounded-[2px]"
                style={{ WebkitBackdropFilter: "blur(12px)", backdropFilter: "blur(12px)" }}
              >
                <p className="font-headline italic text-[#1c1a18] text-[clamp(1.1rem,1.4vw,1.25rem)] leading-[1.4] mb-5">
        ...
        <motion.section 
          ...
          variants={staggerContainer}
          className="bg-[#FAF8F5] py-[clamp(6rem,10vw,10rem)] overflow-hidden relative"
        >
          <div className="max-w-[1400px] mx-auto px-[clamp(1.5rem,5vw,4rem)] relative z-10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-[clamp(4rem,8vw,10rem)] items-center">
              <div className="relative order-2 md:order-1">
                <div className="grid grid-cols-2 gap-[clamp(1rem,2vw,1.5rem)]">
                  <div className="space-y-[clamp(1rem,2vw,1.5rem)] pt-12">
              ...
              <div className="order-1 md:order-2 self-center relative z-10">
                <motion.h2 variants={fadeInUp} className="text-[clamp(2.5rem,4vw,3.5rem)] font-headline text-[#1c1a18] font-light leading-[1.1] tracking-tight mb-[clamp(1.5rem,3vw,2.5rem)] md:max-w-md">
                  Drømmen om ægte nærvær
                </motion.h2>
                <motion.div variants={fadeInUp} className="space-y-6 font-sans text-[clamp(1.05rem,1.4vw,1.15rem)] font-light text-[#6A5D55] leading-relaxed md:max-w-md">
                  <p>
                ...
                <div className="mt-[clamp(3rem,4vw,4rem)] flex items-center justify-center gap-6 md:max-w-md">
        ...
        <motion.section 
          ...
          viewport={{ once: true, margin: "-20%" }}
          variants={staggerContainer}
          className="max-w-[1200px] mx-auto px-[clamp(1.5rem,5vw,4rem)] py-[clamp(6rem,10vw,10rem)] text-center relative"
        >
          <motion.div variants={fadeInUp} className="mb-[clamp(4rem,6vw,8rem)]">
            <span className="font-label text-[clamp(0.6rem,0.8vw,0.75rem)] uppercase tracking-[0.3em] text-[#92857C] mb-[clamp(1.5rem,3vw,2.5rem)] block">
              Vores Manifest
            </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-[clamp(4rem,6vw,6rem)]">
            {[
              ...
              >
                <div className="bg-[#FAF8F5] group-hover:bg-[#F3EFE9] group-hover:-translate-y-2 group-hover:scale-[1.02] transition-all duration-700 ease-in-out p-5 rounded-full mb-[clamp(1.5rem,2vw,2rem)] text-[#887A70] group-hover:text-[#EDB7A9] shadow-[0_4px_20px_rgba(28,26,24,0.03)] group-hover:shadow-[0_15px_30px_rgba(28,26,24,0.06)]">
                ...
                <div className="relative group-hover:-translate-y-2 group-hover:scale-[1.04] transition-all duration-700 ease-in-out w-full flex flex-col items-center">
                  ...
                  <div 
                    className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 ease-in-out pointer-events-none w-full flex flex-col items-center"
                  >
                    <h4 
        ...
        <motion.section 
          ...
          viewport={{ once: true, margin: "-20%" }}
          variants={staggerContainer}
          className="pt-[clamp(6rem,10vw,10rem)] pb-4 bg-[#FAF8F5] overflow-hidden"
        >
          <div className="max-w-[1400px] mx-auto px-[clamp(1.5rem,5vw,4rem)] mb-[clamp(3rem,5vw,5rem)] flex justify-between items-end border-b border-[#4C433C]/10 pb-6">
            <h2 className="text-[clamp(2.5rem,3vw,3.5rem)] font-headline text-[#1c1a18] font-light leading-[1.1]">Bag facaden</h2>
            <span className="font-label text-[clamp(0.6rem,0.8vw,0.7rem)] uppercase tracking-[0.2em] text-[#92857C]">
              Glimt fra hverdagen
            </span>
          </div>
          <div className="flex overflow-x-auto items-center xl:justify-center pb-12 px-[clamp(1.5rem,5vw,4rem)] gap-[clamp(1.5rem,3vw,3rem)] no-scrollbar scroll-smooth">
            <motion.div variants={imageReveal} className="flex-none w-[clamp(280px,30vw,400px)] relative group cursor-pointer shadow-[0_10px_30px_rgba(28,26,24,0.06)] overflow-hidden rounded-[4px] hover:-translate-y-2 transition-transform duration-700 ease-in-out">
            ...
            <motion.div variants={imageReveal} className="flex-none w-[clamp(200px,25vw,300px)] relative mt-16 group cursor-pointer shadow-[0_10px_30px_rgba(28,26,24,0.06)] overflow-hidden rounded-[4px] hover:-translate-y-2 transition-transform duration-700 ease-in-out">
            ...
            <motion.div variants={imageReveal} className="flex-none w-[clamp(300px,35vw,500px)] relative group cursor-pointer shadow-[0_10px_30px_rgba(28,26,24,0.06)] overflow-hidden rounded-[4px] hover:-translate-y-2 transition-transform duration-700 ease-in-out">
            ...
            <motion.div variants={imageReveal} className="flex-none w-[clamp(250px,28vw,350px)] relative mt-8 group cursor-pointer shadow-[0_10px_30px_rgba(28,26,24,0.06)] overflow-hidden rounded-[4px] hover:-translate-y-2 transition-transform duration-700 ease-in-out">
        ...
        <motion.section 
          ...
          variants={staggerContainer}
          className="w-full relative px-[clamp(1.5rem,5vw,4rem)] pt-[clamp(6rem,8vw,10rem)] pb-[clamp(8rem,14vw,12rem)] overflow-hidden flex flex-col items-center justify-center text-center bg-white"
        >
          {/* Top Seamless Transition from #FAF8F5 to white */}
          <div className="absolute top-0 left-0 w-full h-[clamp(150px,30vw,300px)] bg-gradient-to-b from-[#FAF8F5] to-transparent pointer-events-none z-10"></div>
          ...
          <div className="absolute bottom-0 left-[10%] w-[clamp(300px,50vw,800px)] aspect-square z-0 pointer-events-none opacity-40 translate-y-1/2">
          ...
          <div className="absolute bottom-0 right-[10%] w-[clamp(300px,50vw,800px)] aspect-square z-0 pointer-events-none opacity-40 translate-y-1/2">
          ...
          <div className="relative z-10 max-w-[800px] mx-auto">
            <motion.h2 variants={fadeInUp} className="font-headline font-light text-[clamp(2.5rem,4vw,4rem)] text-[#1c1a18] leading-[1.1] mb-[clamp(1rem,2vw,1.5rem)] tracking-tight">
              Klar til din transformation?
            </motion.h2>
            <motion.p variants={fadeInUp} className="text-[clamp(1.1rem,1.5vw,1.3rem)] font-sans text-[#6A5D55] font-light leading-relaxed mb-[clamp(2.5rem,4vw,3.5rem)] max-w-xl mx-auto">
              Oplev forskellen ved et besøg, hvor tiden står stille, og dit hår er i
              centrum.
            </motion.p>
            <motion.div variants={fadeInUp}>
              <Link 
                className="inline-block bg-[#EDB7A9] text-white px-[clamp(2rem,3.5vw,3rem)] py-[clamp(1rem,1.5vw,1.25rem)] rounded-full font-label tracking-[0.2em] uppercase text-[clamp(0.7rem,1vw,0.8rem)] font-bold shadow-[0_15px_40px_rgba(237,183,169,0.4)] hover:shadow-[0_20px_50px_rgba(237,183,169,0.6)] hover:-translate-y-1 hover:bg-[#e6a896] transition-all duration-400"
                href="?booking=true"
                scroll={false}
              >
                Find din tid her
