    ...
    <div className="bg-[#FDFBF7] text-[#1c1a18] font-sans antialiased min-h-screen flex flex-col selection:bg-[#EDB7A9] selection:text-white">
      ...
      <main className="flex-1 pt-[clamp(7rem,10vw,10rem)] 2xl:pt-[clamp(10rem,12vw,12rem)] pb-0 overflow-x-hidden">
        ...
        <motion.section 
          ...
          className="max-w-[1400px] mx-auto px-[clamp(1.5rem,5vw,4rem)] mb-[clamp(5rem,8vw,8rem)] 2xl:mb-[clamp(8rem,10vw,10rem)] relative"
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-[clamp(3.5rem,7vw,7rem)] 2xl:gap-[clamp(7rem,8vw,8rem)] items-center relative z-10">
            ...
            <div className="relative">
              ...
              <motion.div 
                ...
                className="absolute -bottom-8 -left-8 bg-[#FDFBF7]/80 backdrop-blur-md p-[clamp(1.3rem,2.5vw,2rem)] 2xl:p-[clamp(2rem,3vw,2.5rem)] max-w-[280px] 2xl:max-w-[320px] shadow-[-30px_40px_100px_rgba(237,183,169,0.15)] z-10 hidden md:block rounded-[2px]"
                style={{ WebkitBackdropFilter: "blur(12px)", backdropFilter: "blur(12px)" }}
              >
                <p className="font-headline italic text-[#1c1a18] text-[clamp(1rem,1.2vw,1.1rem)] 2xl:text-[clamp(1.1rem,1.4vw,1.25rem)] leading-[1.4] mb-4 2xl:mb-5">
          ...
          <div className="max-w-[1400px] mx-auto px-[clamp(1.5rem,5vw,4rem)] relative z-10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-[clamp(3.5rem,7vw,8rem)] 2xl:gap-[clamp(4rem,8vw,10rem)] items-center">
              ...
              <div className="order-1 md:order-2 self-center relative z-10">
                <motion.h2 variants={fadeInUp} className="text-[clamp(2.2rem,3.5vw,3rem)] 2xl:text-[clamp(2.5rem,4vw,3.5rem)] font-headline text-[#1c1a18] font-light leading-[1.1] tracking-tight mb-[clamp(1.3rem,2.5vw,2rem)] 2xl:mb-[clamp(1.5rem,3vw,2.5rem)] md:max-w-md">
                  Drømmen om ægte nærvær
                </motion.h2>
                <motion.div variants={fadeInUp} className="space-y-6 font-sans text-[clamp(0.95rem,1.2vw,1rem)] 2xl:text-[clamp(1.05rem,1.4vw,1.15rem)] font-light text-[#6A5D55] leading-relaxed md:max-w-md">
                  <p>
                ...
                <div className="mt-[clamp(2.5rem,3.5vw,3.5rem)] 2xl:mt-[clamp(3rem,4vw,4rem)] flex items-center justify-center gap-6 md:max-w-md">
        ...
        >
          <motion.div variants={fadeInUp} className="mb-[clamp(3.5rem,5vw,7rem)] 2xl:mb-[clamp(4rem,6vw,8rem)]">
            <span className="font-label text-[clamp(0.6rem,0.7vw,0.7rem)] 2xl:text-[clamp(0.7rem,0.8vw,0.75rem)] uppercase tracking-[0.3em] text-[#92857C] mb-[clamp(1.3rem,2.5vw,2rem)] 2xl:mb-[clamp(1.5rem,3vw,2.5rem)] block">
              Vores Manifest
            </span>
            <h2 className="text-[clamp(2.2rem,3.5vw,4rem)] 2xl:text-[clamp(2.5rem,4vw,4.5rem)] font-headline text-[#1c1a18] font-light leading-[1.05] tracking-tight">
          ...
          `}</style>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-[clamp(3.5rem,5vw,5rem)] 2xl:gap-[clamp(4rem,6vw,6rem)]">
            {[
              ...
              >
                ...
                <div className="relative group-hover:-translate-y-2 group-hover:scale-[1.04] transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] w-full flex flex-col items-center">
                  ...
                  >
                    <h4 
                      className="font-headline text-[clamp(1.3rem,1.8vw,1.5rem)] 2xl:text-[clamp(1.5rem,2vw,1.75rem)] font-light mb-4 text-transparent whitespace-nowrap animate-wave-rtl"
                      style={{ 
